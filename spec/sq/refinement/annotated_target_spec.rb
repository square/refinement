...
RSpec.describe Sq::Refinement::AnnotatedTarget do
  subject(:annotated_target) { described_class.new(target:, change_reason:, dependencies:) }
  ...
  describe '#change_reason' do
    subject(:change_reason_at_level) { annotated_target.change_reason(level:) }
